...
fn build_scores_table(results: &str) -> HashMap<&str, Team> {
    ...
    for line in results.lines() {
        ...
        match scores.get(&team_1_name){
            ...
            Some(Team{goals_scored:s, goals_conceded:c}) => scores.insert(team_1_name, Team{goals_scored: team_1_score + s, goals_conceded: team_2_score + c}),
        };
        match scores.get(&team_2_name){
            None => scores.insert(team_2_name, Team{goals_scored:team_2_score, goals_conceded:team_1_score}),
            Some(Team{goals_scored:s, goals_conceded:c}) => scores.insert(team_2_name, Team{goals_scored: team_2_score + s, goals_conceded: team_1_score + c}),
        };
